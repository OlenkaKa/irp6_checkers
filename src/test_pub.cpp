...
#include "irp6_checkers/Checker.h"
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher chatter_pub = n.advertise<irp6_checkers::Chessboard>("chatter", 1000);
  ...
  while (ros::ok())
  {
	...
	//ROS_INFO("Message send: %d, %d, %d", data.type, data.x, data.y);
